...
export default function Home() {
  ...
  return (
    <div className="flex-grow bg-[radial-gradient(ellipse_at_top_left,_rgba(255,248,244,1)_0%,rgba(255,240,236,1)_40%,rgba(255,232,228,1)_100%)] text-slate-900 relative overflow-visible">
      {/* Cursor glow effect */}
      <div
        className="pointer-events-none fixed inset-0 z-30 transition duration-300"
        style={{
          background: `radial-gradient(600px at ${mousePosition.x}px ${mousePosition.y}px, rgba(255, 120, 120, 0.09), transparent 80%)`,
        }}
      />
      <BackgroundLayers />
...
function BackgroundLayers() {
  return (
    <>
      <div className="fixed inset-0 bg-gradient-to-tl from-rose-200/30 via-rose-100 to-rose-200/30" />
      <div 
